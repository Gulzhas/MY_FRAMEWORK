package com.swift.secure.utils;
...
/**
 *  @author skrishnan
 *  CRITICAL WARNING - DO NOT TOUCH OR REPRODUCE IN ANY OTHER FORMAT. 
 *  CONTACT AUTHOR FOR ANY Queries/Modifications
 */
public class CryptionAlgorithm {
	public CryptionAlgorithm() {
		super();
	}
	private static final String salt = "SwiftyGiftySaltySolutions";
	...
	private static char[] getMasterPassword() {
		return "GD@Is*gR8#dIsB%UR-SE".toCharArray();
	}
	...
	public static String decryptString(String input) throws Exception {
		if (input.length() <= IV_LENGTH) {
			throw new Exception("The Encrypted String is not long enough");
		}
